        ...
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex md:grow">
            ...
            <li>
              ...
              <li>
                <Link to="" className="font-medium text-purple-600 hover:text-gray-200 px-4 py-3 flex items-center transition duration-150 ease-in-out">Hackathon</Link>
              </li>
              <li>
                <Link to="" className="font-medium text-purple-600 hover:text-gray-200 px-4 py-3 flex items-center transition duration-150 ease-in-out">Templetes</Link>
              </li>
              <li>
                <Link to="" className="font-medium text-purple-600 hover:text-gray-200 px-4 py-3 flex items-center transition duration-150 ease-in-out">Contact us</Link>
              </li>
              {/* <li>
